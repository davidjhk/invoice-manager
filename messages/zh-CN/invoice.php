...
return [
    ...
    'Automatic Calculation' => '自动计算',
    'Calculate' => '计算',
    'Please select a customer first to calculate automatic tax.' => '请先选择客户以计算自动税费。',
    'Calculating...' => '计算中...',
    'Failed to calculate automatic tax.' => '自动税费计算失败。',
    'Error calculating tax. Using company default.' => '税费计算错误。使用公司默认值。',
    ...
    'Quantity' => '数量',
    'Price' => '价格',
    'No items found for this invoice.' => '此发票未找到项目。',
    'Customer Information' => '客户信息',
    'Payment Status' => '付款状态',
    'Invoice Total' => '发票总额',
    'Amount Paid' => '已付金额',
    ...
    'Subtotal' => '小计',
    'Shipping Fee' => '运费',
    'Customer and company are required' => '需要客户和公司',
    'Customer or company not found' => '未找到客户或公司',
    'Using company default tax rate (address not found or invalid)' => '使用公司默认税率（地址未找到或无效）',
];