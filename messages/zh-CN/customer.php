<?php
/**
 * Simplified Chinese translations for customer module
 */
return [
    // General
    'Customer' => '客户',
    ...
    'Are you sure you want to delete this customer?' => '您确定要删除此客户吗？',
    ...
    'Enter full address' => '输入完整地址',
    'Enter city' => '输入城市',
    'Enter state/province' => '输入省/州',
    'Enter postal code' => '输入邮政编码',
    'Select country' => '选择国家',
    'Enter tax ID' => '输入税务ID',
    'Select currency' => '选择货币',
    'Select payment terms' => '选择付款条款',
    'Enter credit limit' => '输入信用额度',
    'Enter notes' => '输入备注',
    'Select status' => '选择状态',
    ...
    'Estimate History' => '估价单历史',
    'No invoices found for this customer' => '未找到此客户的发票',
    'No estimates found for this customer' => '未找到此客户的估价单',
    'You haven\'t created any customers yet.' => '您还没有创建任何客户。',
    'Create Your First Customer' => '创建您的第一个客户',
    ...
    'Select terms' => '选择条件',
    'Select State' => '选择州',
    'Customer name is required.' => '客户姓名是必需的。',
    'Customer added successfully!' => '客户添加成功！',
    'Failed to add customer. Please try again.' => '添加客户失败。请重试。',
    'Error adding customer. Please try again.' => '添加客户时出错。请重试。',
    'Phone number can only contain numbers, spaces, parentheses, plus signs, hyphens, periods, hash and asterisk symbols.' => '电话号码只能包含数字、空格、括号、加号、连字符、句号、井号和星号。',
];