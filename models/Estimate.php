...
class Estimate extends ActiveRecord
{
    ...
    {
        $labels = [
            'id' => Yii::t('app/estimate', 'ID'),
            'estimate_number' => Yii::t('app/estimate', 'Estimate Number'),
            'company_id' => Yii::t('app/estimate', 'Company'),
            'customer_id' => Yii::t('app/estimate', 'Customer'),
            'estimate_date' => Yii::t('app/estimate', 'Estimate Date'),
            'expiry_date' => Yii::t('app/estimate', 'Expiry Date'),
            'subtotal' => Yii::t('app/estimate', 'Subtotal'),
            'tax_rate' => Yii::t('app/estimate', 'Tax Rate (%)'),
            'tax_amount' => Yii::t('app/estimate', 'Tax Amount'),
            'total_amount' => Yii::t('app/estimate', 'Total Amount'),
            'notes' => Yii::t('app/estimate', 'Notes'),
            'status' => Yii::t('app/estimate', 'Status'),
            'currency' => Yii::t('app/estimate', 'Currency'),
            'bill_to_address' => Yii::t('app/estimate', 'Bill To Address'),
            'bill_to_city' => Yii::t('app/estimate', 'Bill To City'),
            'bill_to_state' => Yii::t('app/estimate', 'Bill To State'),
            'bill_to_zip_code' => Yii::t('app/estimate', 'Bill To ZIP Code'),
            'bill_to_country' => Yii::t('app/estimate', 'Bill To Country'),
            'ship_to_address' => Yii::t('app/estimate', 'Ship To Address'),
            'ship_to_city' => Yii::t('app/estimate', 'Ship To City'),
            'ship_to_state' => Yii::t('app/estimate', 'Ship To State'),
            'ship_to_zip_code' => Yii::t('app/estimate', 'Ship To ZIP Code'),
            'ship_to_country' => Yii::t('app/estimate', 'Ship To Country'),
            'ship_from_address' => Yii::t('app/estimate', 'Ship From Address'),
            'shipping_date' => Yii::t('app/estimate', 'Shipping Date'),
            'tracking_number' => Yii::t('app/estimate', 'Tracking Number'),
            'shipping_method' => Yii::t('app/estimate', 'Shipping Method'),
            'terms' => Yii::t('app/estimate', 'Terms'),
            'payment_instructions' => Yii::t('app/estimate', 'Payment Instructions'),
            'customer_notes' => Yii::t('app/estimate', 'Customer Notes'),
            'memo' => Yii::t('app/estimate', 'Internal Memo'),
            'discount_type' => Yii::t('app/estimate', 'Discount Type'),
            'discount_value' => Yii::t('app/estimate', 'Discount Value'),
            'discount_amount' => Yii::t('app/estimate', 'Discount Amount'),
            'shipping_fee' => Yii::t('app/estimate', 'Shipping Fee'),
            'converted_to_invoice' => Yii::t('app/estimate', 'Converted to Invoice'),
            'invoice_id' => Yii::t('app/estimate', 'Invoice'),
            'user_id' => Yii::t('app/estimate', 'User'),
            'created_at' => Yii::t('app/estimate', 'Created At'),
            'updated_at' => Yii::t('app/estimate', 'Updated At'),
        ];
