...
class Invoice extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        $labels = [
            ...
            'invoice_number' => Yii::t('app/invoice', 'Invoice Number'),
            'company_id' => Yii::t('app/invoice', 'Company ID'),
            'customer_id' => Yii::t('app/invoice', 'Customer ID'),
            'invoice_date' => Yii::t('app/invoice', 'Invoice Date'),
            'due_date' => Yii::t('app/invoice', 'Due Date'),
            'subtotal' => Yii::t('app/invoice', 'Subtotal'),
            'tax_rate' => Yii::t('app/invoice', 'Tax Rate (%)'),
            'tax_amount' => Yii::t('app/invoice', 'Tax Amount'),
            'total_amount' => Yii::t('app/invoice', 'Total Amount'),
            'notes' => Yii::t('app/invoice', 'Notes'),
            'status' => Yii::t('app/invoice', 'Status'),
            'currency' => Yii::t('app/invoice', 'Currency'),
            'bill_to_address' => Yii::t('app/invoice', 'Bill To Address'),
            'bill_to_city' => Yii::t('app/invoice', 'Bill To City'),
            'bill_to_state' => Yii::t('app/invoice', 'Bill To State'),
            'bill_to_zip_code' => Yii::t('app/invoice', 'Bill To ZIP Code'),
            'bill_to_country' => Yii::t('app/invoice', 'Bill To Country'),
            'ship_to_address' => Yii::t('app/invoice', 'Ship To Address'),
            'ship_to_city' => Yii::t('app/invoice', 'Ship To City'),
            'ship_to_state' => Yii::t('app/invoice', 'Ship To State'),
            'ship_to_zip_code' => Yii::t('app/invoice', 'Ship To ZIP Code'),
            'ship_to_country' => Yii::t('app/invoice', 'Ship To Country'),
            'ship_from_address' => Yii::t('app/invoice', 'Ship From Address'),
            'shipping_date' => Yii::t('app/invoice', 'Shipping Date'),
            'tracking_number' => Yii::t('app/invoice', 'Tracking Number'),
            'shipping_method' => Yii::t('app/invoice', 'Shipping Method'),
            'terms' => Yii::t('app/invoice', 'Terms'),
            'payment_instructions' => Yii::t('app/invoice', 'Payment Instructions'),
            'customer_notes' => Yii::t('app/invoice', 'Customer Notes'),
            'memo' => Yii::t('app/invoice', 'Internal Memo'),
            'discount_type' => Yii::t('app/invoice', 'Discount Type'),
            'discount_value' => Yii::t('app/invoice', 'Discount Value'),
            'discount_amount' => Yii::t('app/invoice', 'Discount Amount'),
            'shipping_fee' => Yii::t('app/invoice', 'Shipping Fee'),
            'deposit_amount' => Yii::t('app/invoice', 'Deposit Amount'),
            'created_at' => Yii::t('app/invoice', 'Created At'),
            'updated_at' => Yii::t('app/invoice', 'Updated At'),
        ];
