...
class Company extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'company_name' => Yii::t('app/company', 'Company Name'),
            'company_address' => Yii::t('app/company', 'Company Address'),
            'city' => Yii::t('app/company', 'City'),
            'state' => Yii::t('app/company', 'State'),
            'zip_code' => Yii::t('app/company', 'ZIP Code'),
            'country' => Yii::t('app/company', 'Country'),
            'company_phone' => Yii::t('app/company', 'Company Phone'),
            'company_email' => Yii::t('app/company', 'Company Email'),
            'logo_path' => Yii::t('app/company', 'Logo Path'),
            'logo_filename' => Yii::t('app/company', 'Logo Filename'),
            'logo_upload' => Yii::t('app/company', 'Company Logo'),
            'smtp2go_api_key' => Yii::t('app/company', 'SMTP2GO API Key'),
            'sender_email' => Yii::t('app/company', 'Sender Email'),
            'sender_name' => Yii::t('app/company', 'Sender Name'),
            'bcc_email' => Yii::t('app/company', 'BCC Email'),
            'tax_rate' => Yii::t('app/company', 'Tax Rate (%)'),
            'currency' => Yii::t('app/company', 'Currency'),
            'invoice_prefix' => Yii::t('app/company', 'Invoice Prefix'),
            'estimate_prefix' => Yii::t('app/company', 'Estimate Prefix'),
            'due_date_days' => Yii::t('app/company', 'Due Date Days'),
            'estimate_validity_days' => Yii::t('app/company', 'Estimate Validity Days'),
            'is_active' => Yii::t('app/company', 'Is Active'),
            'dark_mode' => Yii::t('app/company', 'Dark Mode'),
            'use_cjk_font' => Yii::t('app/company', 'Use CJK Fonts for PDF'),
            'pdf_template' => Yii::t('app/company', 'PDF Template'),
            'compact_mode' => Yii::t('app/company', 'Compact Mode'),
            'language' => Yii::t('app/company', 'Interface Language'),
            'user_id' => Yii::t('app/company', 'Owner'),
            'created_at' => Yii::t('app/company', 'Created At'),
            'updated_at' => Yii::t('app/company', 'Updated At'),
        ];
    }
