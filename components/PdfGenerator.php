...
class InvoicePDF extends TCPDF
{
    public function Footer()
    {
        ...
        // Add footer text
        $footerText = 'Generated by Jdosa Invoice Manager on ' . date('F j, Y \a\t g:i A');
...
class PdfGenerator
{
    ...
    public static function generateInvoicePdf(Invoice $invoice, $mode = 'I')
    {
        ...
        $pdf->SetCreator('Invoice Manager');
     ...
     * @return string
     */
    private static function getPdfStyles()
    {
        return '
        <style>
            body { font-family: "DejaVu Sans", "FreeSerif", "Times", sans-serif; font-size: 9px; line-height: 1.4; }
            ...
            * { text-indent: 0 !important; margin-left: 0 !important; }
            ...
            .logo { max-height: 72px; max-width: 180px; }
        </style>';
    }
    ...
    private static function generatePdfHeader($company)
    {
        ...
        if ($company->hasLogo()) {
            ...
            if ($logoPath && file_exists($logoPath)) {
                $html .= '<img src="' . $logoPath . '" class="logo" alt="Company Logo">';
            }
        }
    ...
    private static function generatePdfItemsTable($items, $invoice)
    {
        ...
        foreach ($items as $item) {
            ...
            if (!empty($item->product_service_name)) {
                $description .= '<span style="font-family: notosanskr;"><strong>' . htmlspecialchars($item->product_service_name) . '</strong></span>';
                if (!empty($item->description)) {
                    $description .= '<br><span style="font-family: notosanskr;">' . htmlspecialchars($item->description) . '</span>';
                }
            } else if (!empty($item->description)) {
                $description = '<span style="font-family: notosanskr;">' . htmlspecialchars($item->description) . '</span>';
            }
...
<?php
    ...
    private static function generatePreviewFooter()
    {
        ...
        <div style="margin-top: 40px; text-align: center; font-size: 12px; color: #666; border-top: 1px solid #eee; padding-top: 20px;">
            Generated by Jdosa Invoice Manager on ' . date('F j, Y \a\t g:i A') . '
        </div>';
    }
