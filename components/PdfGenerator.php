...
class InvoicePDF extends TCPDF
{
    ...
    public function Footer()
    {
        ...
        // Get company data from header data to check hide_footer setting
        $company = $this->headerData['company'] ?? null;
        $hideFooter = $company && isset($company->hide_footer) && $company->hide_footer;
        
        // Page numbering (always show, right aligned)
        $pageText = 'Page ' . $this->getAliasNumPage() . '/' . $this->getAliasNbPages();
        
        if (!$hideFooter) {
            // Show footer text and page numbering
            ...
            // Move to next line for page numbering
            $this->Ln(2);
        }
        
        // Add page numbering (right aligned, full width)
        $this->Cell(0, 6, $pageText, 0, 1, 'R');
    }
}
    ...
    public static function getTemplateStyles($useCJKFont = false, $colorScheme = '#667eea')
    {
        ...
        <style>
            ...
            * { text-indent: 0 !important; margin-left: 0 !important; }
            ...
            .company-info { font-size: 10px; line-height:61.4; text-indent: 0; ' . $letterSpacing . ' }
