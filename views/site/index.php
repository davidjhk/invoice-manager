...
<div class="site-index">
    ...
    <div class="jumbotron text-center bg-transparent" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 10px;">
        <h1 class="display-4">Invoice Manager</h1>
        <p class="lead">Professional invoice management system</p>
        <?= Html::a('Create New Invoice', ['/invoice/create'], ['class' => 'btn btn-light btn-lg']) ?>
    </div>
