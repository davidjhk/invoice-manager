			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<small class="form-text text-muted"><?= Html::encode($setting->description) ?></small>
						<?php elseif ($setting->setting_key === 'email_notifications'): ?>
						<div class="custom-control custom-switch">
							<?= Html::checkbox($setting->setting_key, $setting->setting_value, [
                                    'class' => 'custom-control-input',
                                    'id' => $setting->setting_key,
						...
						<small class="form-text text-muted"><?= Html::encode($setting->description) ?></small>
						<?php elseif ($setting->setting_key === 'backup_enabled'): ?>
						<div class="custom-control custom-switch">
							<?= Html::checkbox($setting->setting_key, $setting->setting_value, [
                                    'class' => 'custom-control-input',
                                    'id' => $setting->setting_key,
		...
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body">
					...
					<p class="text-muted small">When enabled, new users can register accounts. When disabled, the signup
						page will be inaccessible.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    // Handle checkbox changes for better user experience
