	...
	<div class="row">
		<div class="col-md-12">
			<div class="alert alert-info">
				...
				<p class="mb-2">You are currently logged in as a <strong>demo user</strong>. This mode allows you to
					explore the system with the following restrictions:</p>
				<ul class="mb-3">
				...
				<p class="mb-0">
					<strong>Demo Credentials:</strong> Username: <code>demo</code>, Password: <code>demo123</code>
				</p>
			</div>
		</div>
	</div>
