...
<body>
	...
	<div class="totals">
		<table>
			...
			<tr>
				...
				<td class="text-right" style="color: #dc3545;">-<?= $model->formatAmount($model->discount_amount) ?>
				</td>
			</tr>
			<?php endif; ?>
	...
	<div class="footer">
		<?php if ($model->expiry_date): ?>
		<p><strong>This estimate is valid until
				<?= Yii::$app->formatter->asDate($model->expiry_date, 'php:F j, Y') ?></strong></p>
		<?php endif; ?>
