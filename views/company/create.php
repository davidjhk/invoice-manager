...
<div class="company-create">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <?= $form->field($model, 'company_name')->textInput(['maxlength' => true, 'placeholder' => Yii::t('app/company', 'Enter company name')]) ?>

                    <?= $form->field($model, 'company_address')->textarea(['rows' => 4, 'placeholder' => Yii::t('app/company', 'Enter company address')]) ?>

                    <div class="row">
                        <div class="col-md-6">
                            <?= $form->field($model, 'company_phone')->textInput(['maxlength' => true, 'placeholder' => Yii::t('app/company', 'Enter phone number')]) ?>
                        </div>
                        <div class="col-md-6">
                            <?= $form->field($model, 'company_email')->input('email', ['maxlength' => true, 'placeholder' => Yii::t('app/company', 'Enter company email')]) ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-image mr-2"></i><?= Yii::t('app/company', 'Company Logo') ?>
                    </h5>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label class="form-label font-weight-bold"><?= Yii::t('app/company', 'Upload Logo') ?></label>
                        ...
                        <small class="form-text text-muted">
                            <?= Yii::t('app/company', 'Recommended: PNG or JPG format, max size 2MB, optimal dimensions: 300x100px') ?>
                        </small>
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <?= $form->field($model, 'smtp2go_api_key')->passwordInput([
                        'maxlength' => true,
                        'placeholder' => Yii::t('app/company', 'Enter your SMTP2GO API key (optional)')
                    ]) ?>
                    ...
                    <?= $form->field($model, 'bcc_email')->input('email', [
                        'maxlength' => true,
                        'placeholder' => Yii::t('app/company', 'admin@yourcompany.com (optional)')
                    ]) ?>
                    ...
                    <div class="alert alert-info">
                        <small>
                            ...
                            <a href="https://www.smtp2go.com" target="_blank"><?= Yii::t('app/company', 'Get your SMTP2GO API key here') ?></a>.
                        </small>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <i class="fas fa-file-invoice mr-2"></i><?= Yii::t('app/company', 'Invoice Settings') ?>
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <?= $form->field($model, 'tax_rate')->textInput([
                        ...
                        'max' => 100,
                        'step' => 0.01,
                        'placeholder' => Yii::t('app/company', '10.00')
                    ]) ?>
                </div>
                <div class="col-md-3">
    ...
    $('#logo-upload').change(function(e) {
        ...
        if (file) {
            if (file.size > 2 * 1024 * 1024) { // 2MB limit
                alert('<?= Yii::t('app/company', 'File size must be less than 2MB') ?>');
                this.value = '';
                return;
            }
