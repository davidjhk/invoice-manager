...
<head>
	...
	<style>
		...
		* {
		...
		/* Animated Background - Safari Optimized */
		body::before {
			content: '';
			position: fixed;
			top: -50%;
		...
		body::after {
			...
			right: 0;
			bottom: 0;
			background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"><defs><radialGradient id="a"><stop offset="0" stop-color="%23ffffff" stop-opacity="0.1"/><stop offset="1" stop-color="%23ffffff" stop-opacity="0"/></radialGradient></defs><g opacity="0.4"><circle cx="200" cy="200" r="180" fill="url(%23a)"/><circle cx="800" cy="300" r="120" fill="url(%23a)"/><circle cx="600" cy="700" r="140" fill="url(%23a)"/><circle cx="100" cy="800" r="100" fill="url(%23a)"/></g></svg>') no-repeat center center;
