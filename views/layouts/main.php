...
<head>
	...
	body .main-navbar .navbar-nav .nav-link::after {
		content: '' !important;
		position: absolute !important;
		top: 50% !important;
		right: 5% !important;
	...
	body .main-navbar .dropdown .nav-link {
		...
		line-height: 1.25 !important;
		vertical-align: middle !important;
		/* Enhanced Glass Style - 드롭다운 기본 상태 */
		background: rgba(75, 85, 99, 0.12) !important;
		border: 1px solid rgba(156, 163, 175, 0.25) !important;
		backdrop-filter: blur(12px) saturate(150%) !important;
		box-shadow:
	...
	body .main-navbar .dropdown .nav-link::after {
		content: '' !important;
		position: absolute !important;
		top: 50% !important;
		right: 5% !important;
	...
	body .main-navbar .dropdown .nav-link:hover {
		...
		text-decoration: none !important;
		transform: translateY(-3px) scale(1.02) !important;
		/* Enhanced Glass Style - 드롭다운 호버 상태 */
		background: rgba(255, 255, 255, 0.18) !important;
		border: 1px solid rgba(255, 255, 255, 0.3) !important;
		backdrop-filter: blur(16px) saturate(180%) !important;
		box-shadow:
	...
	/* Dark mode top bar Change Mode button */
	body.dark-mode .top-bar .btn:hover,
	body.dark-mode .top-bar .btn:active,
	body.dark-mode .top-bar .btn.active {
	...
	/* Dark mode top bar button icons and arrows */
	body.dark-mode .top-bar .btn:hover i,
	body.dark-mode .top-bar .btn:active i,
	body.dark-mode .top-bar .btn.active i,
	body.dark-mode .top-bar .btn:hover .fas,
	body.dark-mode .top-bar .btn:active .fas,
	body.dark-mode .top-bar .btn.active .fas,
	body.dark-mode .top-bar .btn:hover .fa,
	body.dark-mode .top-bar .btn:active .fa,
	body.dark-mode .top-bar .btn.active .fa {
		color: #ffffff !important;
	}

	/* Dark mode top bar dropdown toggle when open */
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle {
		background-color: rgba(31, 41, 55, 0.8) !important;
		color: #ffffff !important;
		border-color: rgba(75, 85, 99, 0.5) !important;
	}

	/* Dark mode top bar dropdown toggle icons when open */
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle i,
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle .fas,
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle .fa {
		color: #ffffff !important;
	}

	/* Dark mode override Bootstrap btn-outline-light active states */
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled).active,
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled):active,
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle {
		background-color: rgba(31, 41, 55, 0.8) !important;
		color: #ffffff !important;
	...
	/* Dark mode override Bootstrap btn-outline-light active states icons */
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled).active i,
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled):active i,
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle i,
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled).active .fas,
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled):active .fas,
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle .fas,
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled).active .fa,
	body.dark-mode .top-bar .btn-outline-light:not(:disabled):not(.disabled):active .fa,
	body.dark-mode .top-bar .show>.btn-outline-light.dropdown-toggle .fa {
		color: #ffffff !important;
	}
	...
	body:not(.dark-mode) .dropdown-submenu .dropdown-item {
		color: #374151 !important;
	}

	body:not(.dark-mode) .dropdown-submenu .dropdown-item:hover,
	body:not(.dark-mode) .dropdown-submenu .dropdown-item:focus {
		background: rgba(249, 250, 251, 0.8) !important;
		color: #4f46e5 !important;
	}

	body:not(.dark-mode) .dropdown-submenu .dropdown-item.active {
		background: rgba(99, 102, 241, 0.1) !important;
		color: #4f46e5 !important;
	...
	body.dark-mode .dropdown-submenu .dropdown-item {
		color: #d1d5db !important;
	}

	body.dark-mode .dropdown-submenu .dropdown-item:hover,
	body.dark-mode .dropdown-submenu .dropdown-item:focus {
		background: rgba(99, 102, 241, 0.2) !important;
		color: #a5b4fc !important;
	}

	body.dark-mode .dropdown-submenu .dropdown-item.active {
	...
	<header>
					...
					<div class="user-menu d-flex align-items-center">
						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<?php 
								// Get user's companies for switch company dropdown
								$userCompanies = \app\models\Company::findForCurrentUser()
		...
		<div class="mobile-nav-overlay">
			<div class="mobile-nav-menu">
				...
				<!-- Settings Menu -->
				<?= Html::a('<i class="fas fa-cog mr-2"></i>' . Yii::t('app/nav', 'Company Settings'), ['/company/settings'], ['class' => 'nav-link mobile-nav-link']) ?>
