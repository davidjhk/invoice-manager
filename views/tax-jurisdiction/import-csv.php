...
<div class="tax-jurisdiction-import">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="replace_existing" name="replace_existing" value="1">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-info-circle mr-2"></i><?= Yii::t('app', 'CSV Format Requirements') ?></h5>
                </div>
                <div class="card-body">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <pre class="bg-light p-2 small rounded"><code>State,ZipCode,TaxRegionName,EstimatedCombinedRate,StateRate,EstimatedCountyRate,EstimatedCityRate,EstimatedSpecialRate,RiskLevel
...
NY,10001,NEW YORK,0.082500,0.040000,0.022500,0.020000,0.000000,0</code></pre>
                    ...
                    <pre class="bg-light p-2 small rounded"><code>zip_code,state_code,state_name,county_name,city_name,tax_region_name,combined_rate,state_rate,county_rate,city_rate,special_rate
...
10001,NY,New York,New York,New York,Manhattan Tax Region,8.2500,4.0000,2.2500,2.0000,0.0000</code></pre>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-exclamation-triangle mr-2"></i><?= Yii::t('app', 'Important Notes') ?></h5>
                </div>
                <div class="card-body">
                    <div class="alert alert-warning">
                        <ul class="mb-0 small">
                            <li><?= Yii::t('app', 'Tax rates should be entered as percentages (e.g., 8.25 for 8.25%)') ?></li>
...
$(document).ready(function() {
    ...
    $('#csv_file').on('change', function() {
        ...
        if (file) {
            ...
            if (file.size > 10 * 1024 * 1024) {
                alert('<?= Yii::t('app', 'File size exceeds 10MB limit. Please select a smaller file.') ?>');
                this.value = '';
                return;
            }
    ...
    $('#import-btn').on('click', function(e) {
        ...
        $(this).prop('disabled', true).html('<i class="fas fa-spinner fa-spin mr-2"></i><?= Yii::t('app', 'Importing...') ?>');
        ...
        if (form) {
            ...
            $(this).prop('disabled', false).html('<i class="fas fa-upload mr-2"></i><?= Yii::t('app', 'Import CSV') ?>');
        }
