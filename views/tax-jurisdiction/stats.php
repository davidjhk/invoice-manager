...
<div class="tax-jurisdiction-stats">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="action-buttons">
            <?= Html::a('<i class="fas fa-list mr-2"></i>' . Yii::t('app', 'Tax Management'), ['index'], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('<i class="fas fa-upload mr-2"></i>' . Yii::t('app', 'Import Tax Rates'), ['import-csv'], ['class' => 'btn btn-success']) ?>
            <?= Html::a('<i class="fas fa-download mr-2"></i>' . Yii::t('app', 'Export All'), ['export-csv'], ['class' => 'btn btn-outline-secondary']) ?>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h6 class="card-text"><?= $stats['last_updated'] ? Yii::$app->formatter->asDate($stats['last_updated']) : Yii::t('app', 'Never') ?></h6>
                        </div>
                        <div class="card-icon">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-chart-bar mr-2"></i><?= Yii::t('app', 'Jurisdictions by State') ?></h5>
                </div>
                <div class="card-body">
                            ...
                            <table class="table table-sm table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= Html::encode($jurisdiction->tax_region_name ?: ($jurisdiction->city_name . ', ' . $jurisdiction->county_name)) ?></td>
                                        <td class="text-right">
                                            <span class="badge badge-primary"><?= \app\models\TaxJurisdiction::formatRate($jurisdiction->combined_rate) ?></span>
                                        </td>
                                        <td>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-sm-6"><?= number_format($stats['total_jurisdictions']) ?> <?= Yii::t('app', 'records') ?></dd>
                                
                                <dt class="col-sm-6"><?= Yii::t('app', 'Coverage') ?>:</dt>
                                <dd class="col-sm-6"><?= number_format($stats['states_covered']) ?> <?= Yii::t('app', 'of 50 states') ?></dd>
                                
                                <dt class="col-sm-6"><?= Yii::t('app', 'Latest Effective Date') ?>:</dt>
                                <dd class="col-sm-6"><?= $stats['latest_effective_date'] ? Yii::$app->formatter->asDate($stats['latest_effective_date']) : Yii::t('app', 'N/A') ?></dd>
                            </dl>
                        </div>
                        <div class="col-md-6">
