...
$this->title = Yii::t('app', 'Import Customers');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Customers'), 'url' => ['customer/index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="customer-import-index">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <?= Html::a('<i class="fas fa-arrow-left mr-1"></i>' . Yii::t('app', 'Back to Customers'), 
                ['customer/index'], 
    ...
    <div class="alert alert-info mb-4">
        ...
        <?= Yii::t('app', 'Customer import functionality is available for Pro plan subscribers.') ?>
    </div>
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <ul class="small mb-3">
                                    ...
                                    <li><?= Yii::t('app', 'Customer name is required') ?></li>
                                ...
                                <p class="card-text">
                                    ...
                                    <small class="text-muted">
                                        customer_name*, customer_email, customer_phone, customer_mobile, 
                                        customer_fax, contact_name, customer_address, city, state, 
                                        zip_code, country, billing_address, shipping_address, payment_terms
                                    </small>
                                </p>
                                <p class="card-text">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <?= Html::submitButton('<i class="fas fa-check mr-1"></i>' . Yii::t('app', 'Confirm Import'), [
                        ...
                        'encode' => false,
                        'data-confirm' => Yii::t('app', 'Are you sure you want to import {count} customers?', [
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul>
                        ...
                        <li><?= Yii::t('app', 'Customer name is the only required field') ?></li>
                        <li><?= Yii::t('app', 'Duplicate customers will be skipped') ?></li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <h5><?= Yii::t('app', 'Field Mappings') ?></h5>
                    <ul>
                        <li><strong>customer_name</strong>: <?= Yii::t('app', 'Company or individual name (required)') ?></li>
                        <li><strong>customer_email</strong>: <?= Yii::t('app', 'Primary email address') ?></li>
                        <li><strong>customer_phone</strong>: <?= Yii::t('app', 'Primary phone number') ?></li>
                        <li><strong>payment_terms</strong>: <?= Yii::t('app', 'e.g., "Net 30", "Net 15"') ?></li>
                        <li><strong>country</strong>: <?= Yii::t('app', '2-letter country code (default: US)') ?></li>
                    </ul>
                </div>
            </div>
        </div>
